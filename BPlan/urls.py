...
urlpatterns = [
    ...
    path('inventory/create/', views_inventory.inventory_create_html, name='inventory_create_html'),
    path('inventory/create/add/', views_inventory.inventory_create_add, name='inventory_create_add'),
    path('inventory/change/', views_inventory.inventory_change_html, name='inventory_change_html'),
    ...
    path('inventory/group/create/', views_inventory.inventory_group_create_html, name='inventory_group_create_html'),
